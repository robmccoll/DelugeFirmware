...
public:
	...
	virtual char const* getFilePrefix() { return ""; }
	String
	    dirPath; // This needs to be initialized / defaulted to "SYNTHS" or "KITS" (for those Instrument types). The constructor does not do this, partly because
