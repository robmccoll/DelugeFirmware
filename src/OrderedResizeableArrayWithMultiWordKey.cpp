...
int OrderedResizeableArrayWithMultiWordKey::searchMultiWord(uintptr_t* __restrict__ keyWords, int comparison,
...
int OrderedResizeableArrayWithMultiWordKey::searchMultiWordExact(uintptr_t* __restrict__ keyWords,
...
int OrderedResizeableArrayWithMultiWordKey::insertAtKeyMultiWord(uintptr_t* __restrict__ keyWords, int rangeBegin,
                                                                 int rangeEnd) {
