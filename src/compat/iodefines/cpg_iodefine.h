...
#define CPG_FROM_STBCR3_ARRAY_ADDRESS_LIST                                                                             \
	{ /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                                            \
		&CPG_FROM_STBCR3, &CPG_FROM_STBCR4, &CPG_FROM_STBCR5, &CPG_FROM_STBCR6, &CPG_FROM_STBCR7, &CPG_FROM_STBCR8,    \
		    &CPG_FROM_STBCR9, &CPG_FROM_STBCR10, &CPG_FROM_STBCR11, &CPG_FROM_STBCR12                                  \
	} /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                          /* { } is for MISRA 19.4 */
